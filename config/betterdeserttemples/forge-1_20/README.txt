...
"entries": {
  "minecraft:stone_axe": 0.15,
  "minecraft:shield": 0.2,
  "minecraft:air": 0.1
},
"defaultItem": "minecraft:iron_axe"
For each item, this randomizer has a 15% chance of returning a stone axe, 20% chance of choosing a shield,
10% chance of choosing air (nothing), and a 100 - (15 + 20 + 10) = 45% chance of choosing an iron axe (since it's the default item).
