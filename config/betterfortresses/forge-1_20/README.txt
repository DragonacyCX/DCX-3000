...
This randomizer has a 15% chance of returning cobblestone, 20% chance of choosing air,
10% chance of choosing a stone sword, and a 100 - (15 + 20 + 10) = 45% chance of choosing iron axe (since it's the default item).
